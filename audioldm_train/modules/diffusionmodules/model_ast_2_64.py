...
class ReversePatchEmbed(nn.Module):
    ...
    def forward(self, x):
        x = self.reverproj(x.transpose(1, 2).reshape(2, 768, 64, 4))
        return x
...
class AstModel(nn.Module):
    def __init__(self, d_hid=2048,
        ...
        super().__init__()
        self.model = ASTModel.from_pretrained("MIT/ast-finetuned-audioset-16-16-0.442", max_length=1024, num_mel_bins=64, ignore_mismatched_sizes=True)
