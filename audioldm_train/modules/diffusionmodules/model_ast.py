...
class AstModel(nn.Module):
    def __init__(self, d_hid=2048,
        ...
        super().__init__()
        self.layer1 = nn.Conv2d(512, 128, kernel_size=(1, 1))
        self.layer2 = nn.Conv2d(128, 32, kernel_size=(1, 1))
        self.layer3 = nn.Conv2d(32, 8, kernel_size=(1, 1))
        self.layer4 = nn.Conv2d(8, 1, kernel_size=(1, 1))

        self.model = ASTModel.from_pretrained("MIT/ast-finetuned-audioset-16-16-0.442", max_length=256, num_mel_bins=16, ignore_mismatched_sizes=True)
